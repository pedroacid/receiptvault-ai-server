    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        ...
        },
        {
          role: "user",
          content:
            "Extract vendor, amount, date, and accountNumber from this OCR text. " +
            "For accountNumber, prioritize a card brand line plus a nearby masked-card line. " +
            "Ignore Ref, AID, TVR, Code, Terminal, Trace, Batch, and totals.\n\n" +
            text
        }
      ]
    });
